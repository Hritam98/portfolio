...
"resource": {
  ...
  "macros":[{
      ...
      "vtp_experimentKey":"OPT-5VPWWP_OPT-KQNV4",
      "function":"__c",
      "vtp_value":true
    },{
      "function":"__u",
      ...
      "function":"__exs",
      "vtp_measurementId":"dyIFoouwRqWNUpsk-1AWLw",
      "vtp_sections":["list",2]
    },{
      "vtp_experimentKey":"OPT-5VPWWP_OPT-KQNV4",
      "function":"__c",
      ...
      "function":"__c",
      "vtp_value":["map","",18772,"dyIFoouwRqWNUpsk-1AWLw",18865,"bOw8RoGUQg2AmCKYnwfo4g",18865]
    },{
      "vtp_experimentKey":"OPT-5VPWWP_OPT-WGPWJ",
      "function":"__c",
      "vtp_value":true
    },{
      "function":"__exs",
      "vtp_measurementId":"bOw8RoGUQg2AmCKYnwfo4g",
      "vtp_sections":["list",3]
    },{
      "vtp_experimentKey":"OPT-5VPWWP_OPT-WGPWJ",
      "function":"__c",
  ...
  "tags":[{
      ...
      "vtp_activate":true,
      "vtp_isEmpty":true,
      "vtp_treatmentId":"Experiment_OPT-5VPWWP_OPT-KQNV4:0",
      "vtp_contextIndex":0,
      ...
      "vtp_activate":true,
      "vtp_isEmpty":true,
      "vtp_treatmentId":"Experiment_OPT-5VPWWP_OPT-WGPWJ:0",
      "vtp_contextIndex":0,
      "vtp_useMutationObserver":true,
      "vtp_waitForElements":true,
      "tag_id":41
  ...
  "rules":[
    ...
    [["if",0,8,9,14],["add",7]],
    [["if",0,8,9,15],["add",8]],
    [["if",5],["block",2,3,4,5,6,7,8]],
    [["if",6],["block",2,3,4,5,6,7,8]],
    [["if",7],["block",2,3,4,5,6,7,8]]]
},
"runtime":[]
...
var Nd=[B.B,B.F],Od=function(a){var b=a[B.ke];b&&Ec(40);var c=a[B.me];c&&Ec(41);for(var d=ya(b)?b:[b],e=0;e<d.length;++e)for(var f in a)if(a.hasOwnProperty(f)&&f!==B.ke&&f!==B.me)if(-1<za(Nd,f)){var h=f,k=a[f],l=d[e];yd().set(h,k,l,"IN","IN-WB",c)}else{}},Pd=function(a,
...
var Bi=function(a){if(ui[a]||wi)return;var b=D[Ai()];wa(b)&&(b("provide",a,va),ui[a]=!0);},Ai=function(){return D.GoogleAnalyticsObject||"ga"},Ci=function(a,b){return function(){var c=vi(),d=c&&c.getByName&&c.getByName(a);if(d){var e=d.get("sendHitTask");d.set("sendHitTask",function(f){var h=f.get("hitPayload"),k=f.get("hitCallback"),l=0>h.indexOf("&tid="+b);l&&(f.set("hitPayload",h.replace(/&tid=UA-[0-9]+-[0-9]+/,"&tid="+
...
g(a[1])&&(b={},cb(a[2])||ya(a[2])?b[a[1]]=m(a[2]):b[a[1]]=a[2]);if(b){b._clear=!0;return b}}},Dm={policy:!0};var Gm=function(a,b){var c=a.hide;if(c&&void 0!==c[b]&&c.end){c[b]=!1;var d=!0,e;for(e in c)if(c.hasOwnProperty(e)&&!0===c[e]){d=!1;break}d&&(c.end(),c.end=null)}},Im=function(a){var b=Hm(),c=b&&b.hide;c&&c.end&&(c[a]=!0)};
var Rm=function(){try{var a,b;var c=D[Ai()],d="m";""==d&&(d="t0");b="ga";try{var e=c&&c.getByName&&c.getByName(d);if(e){0===d.indexOf("gtag_")?b="gtag":e.get("&gtm")&&(b="gtm");for(var f in c)if(c.hasOwnProperty(f)){var h=c[f];if("l"!==f&&"answer"!==f&&"number"===typeof h){var k=Jm-h;1E5>k&&0<k&&(a=k)}}}}catch(C){}
var l,n=Te.K,p=Ud('script[src*="gtm/js?id='+n+'"],script[src*="optimize.js?id='+n+'"]');l=p&&0<p.length?p[0]:null;b||(b="gaoo");var r=Km(Lm,l&&l.src),q=r.Wb,t=r.Xb,u=r.Mc,v=r.Nc,x=r.Hc,z=r.Rc,w=r.Rb,y=r.Pd,A=r.Qb;"h0"!=w||Mm||(w="h3");Nm={Rb:w,Qb:A,kh:a,Ch:b,Pd:y,Nc:v,Hc:x,Rc:z,Mc:u,Wb:q,Xb:t,yf:Om,Nf:Pm};Qm(Nm)}catch(C){}},Sm=function(){var a=D.gaData,
b=0,c=void 0;if(a)for(var d in a)if(a.hasOwnProperty(d)&&0===d.indexOf("UA-")&&a[d].hitcount){b+=a[d].hitcount;var e=Number(a[d].first_hit);e&&(!c||e<c)&&(c=e)}return{zf:b,wf:c}},Km=function(a,b){var c,d,e,f,h,k,l,n,p;var r=D.performance;if(r){if(b){var q=r.getEntriesByName(b)[0];if(q){var t=r.getEntriesByType("resource"),u=0;t&&0<t.length&&(u=t[0].startTime);f=Math.round(q.startTime-u);h=Math.round(q.duration);e=t.indexOf(q);-1===e&&(e=void 0);k=Math.round(a-(q.startTime+
q.duration))}}var v=r.timing;if(v.domContentLoadedEventStart){var x=v.domContentLoadedEventStart-v.navigationStart;x&&(d=Math.round(a-x))}var z=r.getEntriesByType("paint").filter(function(C){return"first-contentful-paint"===C.name})[0];z&&(c=Math.round(a-z.startTime))}var w=D["dataLayer"].hide;if(w){if(void 0===w[Te.K])l="h2";else{var y=!1;if(null===w.end)for(var A in w)if(w.hasOwnProperty(A)&&A.startsWith(Te.K)&&!0===w[A]){y=!0;break}l=y?"h0":"h1"}w.start&&!isNaN(w.start)&&(r?r.timing&&(p=Math.round(a+
r.timing.navigationStart-w.start)):p=a-w.start);isNaN(w.timeout)||(n=w.timeout)}return{Wb:d,Xb:c,Mc:e,Nc:f,Hc:h,Rc:k,Rb:l,Pd:n,Qb:p}},Qm=function(a,b){b=void 0===b?"ol":b;var c=function(e,f){null!=f&&(d+=e+encodeURIComponent(f))},d=cf;c("&t=",b);c("&s=",a.Rb);c("&h=",a.Qb);c("&g=",a.kh);c("&p=",a.Ch);c("&o=",a.Pd);c("&l=",af?Jm-Ja(af):void 0);c("&q=",a.Nc);c("&f=",a.Hc);c("&e=",a.Rc);c("&i=",a.Mc);c("&d=",a.Wb);c("&c=",a.Xb);c("&tr=",a.Wh);
c("&jl=",a.Ah);c("&jf=",a.yh);c("&ji=",a.zh);c("&jq=",a.Bh);c("&jd=",a.wh);c("&jx=",a.xh);c("&hc=",a.yf);c("&fh=",a.Nf);d+="&sr=0.050000";c("&ps=",Tm);c("&cb=",Ca());jd(d);},Um=!1,Jm,Lm,Mm,Tm,Nm,Om,Pm;Tm=Math.random(),Um="0.050000">Tm;var Vm=function(){if(!Um||Jm)return;Jm=Pa();Lm=performance&&performance.now()||Jm;Mm=!!F.querySelector("body");var a=Sm(),
b=a.wf;Om=a.zf;Pm=b?Jm-b:void 0;sm(Rm);},Xm=function(a){var b=Wm;if(!Um)return;try{var c=Pa(),d=performance&&performance.now()||c,e=Sm(),f=e.zf,h=e.wf,k=h?c-h:void 0;sm(function(){var l=Km(d,b),n=l.Wb,p=l.Xb,r=l.Mc,q=l.Nc,t=l.Hc,u=l.Rc,v=l.Rb,x=l.Qb,z=m(Nm||{});m(a,z);m({Rb:v,Qb:x,Wb:n,Xb:p,zh:r,Bh:q,wh:t,xh:u,yf:f,Nf:k},z);Qm(z,"od")})}catch(l){}};var Zm=function(a){if(Ym(a))return a;this.m=a};Zm.prototype.oh=function(){return this.m};var Ym=function(a){return!a||"object"!==ab(a)||cb(a)?!1:"getUntrustedUpdateValue"in a};Zm.prototype.getUntrustedUpdateValue=Zm.prototype.oh;var $m=[],an=!1,bn=!1,cn=!1,dn=function(a){return D["dataLayer"].push(a)},en=function(a){var b=M["dataLayer"],c=b?b.subscribers:1,d=0,e=a;return function(){++d===c&&(e(),e=null)}};
function fn(a){var b=a._clear;Fa(a,function(d,e){"_clear"!==d&&(b&&pf(d,void 0),pf(d,e))});af||(af=a["gtm.start"]);Vm();var c=a["gtm.uniqueEventId"];if(!a.event)return!1;c||(c=ff(),a["gtm.uniqueEventId"]=c,pf("gtm.uniqueEventId",c));return yj(a)}function gn(){var a=$m[0];if(null==a||"object"!==typeof a)return!1;if(a.event)return!0;if(Ia(a)){var b=a[0];if("config"===b||"event"===b||"js"===b)return!0}return!1}
...
(void 0===D[a]||c&&!D[a])&&(D[a]=b);return D[a]},Nn=function(a,b,c){return Cf(a,b,void 0===c?!0:!!c)},On=function(a,b,c){return 0===Lf(a,b,c)},Pn=function(a,b){if(wh()){b&&I(b)}else id(a,b)},Qn=function(a){return!!km(a,"init",!1)},Rn=function(a){im(a,"init",!0)},Sn=function(a){var b=Ze+"?id="+encodeURIComponent(a)+"&l=dataLayer";R(yh("https://","http://",b))},Tn=function(a,b,c){ej&&(db(a)||ij(c,b,a))};var Un=mn.Dh;
var Vn=function(a){if(!a||a.nodeType!=Node.ELEMENT_NODE)return!1;var b=a.tagName.toUpperCase();return"SCRIPT"==b||"STYLE"==b||"LINK"==b},Wn=function(a,b,c){try{null==c?a.removeAttribute(b):a.setAttribute(b,c)}catch(d){return d}return null},Xn=function(a,b,c){var d=a.getAttribute(b);return Wn(a,b,c)?8:function(){Wn(a,b,d)}},$n=function(a,b,c){var d,e,f=a.ownerDocument||a.document||document;c=(c||"").toLowerCase();"after"==c?(d=a.parentNode,e=a.nextSibling):"insert"==c?(d=a,e=a.firstChild):"append"==
c?(d=a,e=null):(d=a.parentNode,e=a);if(!d||d==f)return{result:1,rh:[]};var h=Yn(b,d);Zn(h,"SCRIPT");Zn(h,"NOSCRIPT");var k=[];if(h.firstChild)for(var l=h.firstChild;l;){var n=l.nextSibling;k.push(l);d.insertBefore(l,e);l=n}var p=a.nextSibling;"replace"==c&&d.removeChild(a);return{result:function(){for(;0<k.length;)d.removeChild(k.pop());"replace"==c&&d.insertBefore(a,p)},rh:k.slice()}},ao={SELECT:[1,'<select multiple="multiple">',"</select>"],FIELDSET:[1,"<fieldset>","</fieldset>"],MAP:[1,"<map>",
"</map>"],OBJECT:[1,"<object>","</object>"],TABLE:[1,"<table>","</table>"],TBODY:[2,"<table><tbody>","</tbody></table>"],COLGROUP:[2,"<table><colgroup>","</colgroup></table>"],TR:[3,"<table><tbody><tr>","</tr></tbody></table>"]},Yn=function(a,b){var c=0,d="",e="",f=ao[b.tagName];null!=f&&(c=f[0],d=f[1],e=f[2]);var h=b.ownerDocument.createElement("div"),k=Yc(d+(a||"")+e);ad(h,k);for(var l=h;0<c;){var n=l.firstChild;if(null==n.firstChild)return b.ownerDocument.createElement("div");l=n;c--}return l},
Zn=function(a,b){for(var c=a.getElementsByTagName(b),d=[],e=c.length-1;0<=e;e--){var f=c[e];f.parentNode.removeChild(f);d.push(f)}},bo=function(a){var b=null,c=null;try{b=new Function("element",a)}catch(d){c=d}return{Kd:b,error:c}},go=function(a,b,c,d,e){var f=a+"{"+(b+": "+c+(d?" !important":""))+"}";e&&(f=e+"{"+f+"}");var h=document;if(h.createStyleSheet){var k=co(h),l=k.rules.length;k.insertRule(f,l);return function(){k.deleteRule?k.deleteRule(l):k.removeRule(l);k.insertRule("x {}",l)}}var n=eo(f,
h);fo(n,h);var p=n.parentNode;return function(){p.removeChild(n)}},ho=null,co=function(a){if(ho)return ho;for(var b=a.styleSheets.length-1;0<=b;b--){var c=a.styleSheets[b];if(!c.href){var d=c.ownerNode;if(d&&d.parentNode&&"HEAD"==d.parentNode.tagName)return ho=c}}0==a.styleSheets.length&&a.createStyleSheet();return ho=a.styleSheets[0]},eo=function(a,b){var c=(b||document).createElement("style");void 0!==c.cssText?c.cssText=a:c.innerHTML=a;return c},fo=function(a,b){var c=b||document,d=c.getElementsByTagName("head")[0];
d||(d=c.createElement("head"),c.body.parentNode.insertBefore(d,c.body));d.appendChild(a)},io=function(a,b,c,d){if(a.style.setProperty)try{var e=a.style.getPropertyValue(b),f=a.style.getPropertyPriority(b);a.style.setProperty(b,c,d?"important":"");return function(){a.style.setProperty(b,"",f);a.style.setProperty(b,e,f)}}catch(k){}var h=a.style.cssText;a.style.cssText+=";"+(b+": "+c+(d?" !important":""))+";";return function(){a.style.cssText=h}},ko=function(a,b,c,d){if(Vn(a))return 7;if(b)return jo(a,
b,d);if(c&&c.parentNode){var e=a.parentNode,f=a.nextSibling;try{c.parentNode.insertBefore(a,c.nextSibling)}catch(h){return 9}return function(){e.insertBefore(a,f)}}return 4},jo=function(a,b,c){var d=a.parentNode,e=a.nextSibling;c=(c||"").toLowerCase();try{if("bottom"==c)b.appendChild(a);else if("top"==c)b.insertBefore(a,b.childNodes[0]||null);else if("before"==c)if(b.parentNode)b.parentNode.insertBefore(a,b);else return 5;else if("after"==c)if(b.parentNode)b.parentNode.insertBefore(a,b.nextSibling);
else return 5}catch(f){return 9}return function(){try{d.insertBefore(a,e)}catch(f){}}},lo=function(a,b,c){if(0<=b&&b<a.childNodes.length){var d=a.childNodes[b];if(null!=d&&d.nodeType==Node.TEXT_NODE){var e=d.nodeValue;d.nodeValue=c;return function(){d.nodeValue=e}}return 2}return 3},mo=function(a,b,c,d){c?d=c.nextSibling:d&&(c=d.previousSibling);if(null!=c&&c.nodeType==Node.TEXT_NODE){var e=c.nodeValue;c.nodeValue+=a;return function(){c.nodeValue=e}}if(null!=d&&d.nodeType==Node.TEXT_NODE){var f=d.nodeValue;
d.nodeValue=a+d.nodeValue;return function(){d.nodeValue=f}}var h=(b.ownerDocument||b.document||document).createTextNode(a);d?b.insertBefore(h,d):b.appendChild(h);return function(){b.removeChild(h)}},no=function(a){var b=document.createElement("a");a&&(b.href=a);return b};function ro(a,b){a=String(a);b=String(b);var c=a.length-b.length;return 0<=c&&a.indexOf(b,c)==c}var so=new Da;function to(a,b,c){var d=c?"i":void 0;try{var e=String(b)+d,f=so.get(e);f||(f=new RegExp(b,d),so.set(e,f));return f.test(a)}catch(h){return!1}}
...
var Ao=function(a,b,c){for(var d={},e=!1,f=0;a&&f<a.length;f++)a[f]&&a[f].hasOwnProperty(b)&&a[f].hasOwnProperty(c)&&(d[a[f][b]]=a[f][c],e=!0);return e?d:null};var Do=function(a){if(!Bo[a]){Bo[a]=!0;var b=D[a]||{};D[a]=b;var c=function(e){return Co[e]},d=b.get;b.get=d?function(e){return void 0!==Co[e]?Co[e]:d(e)}:c}},Go=function(a,b){Co[a]=b;for(var c=Eo(a),d=0;d<c.length;d++)Fo(c[d],a,b);c=Eo("");for(var e=0;e<c.length;e++)Fo(c[e],a,b)},Fo=function(a,b,c){try{a(c,b,Te.K)}catch(d){}},Eo=function(a){Ho[a]=Ho[a]||[];return Ho[a]},Co={},Ho={},Bo={};
var Io=function(){D.gaData=D.gaData||{};return D.gaData},Jo=function(a,b){b=void 0===b?!1:b;D.gaData=D.gaData||{};var c=D.gaData,d=c.tracker_created;c.tracker_created=function(e){b&&a(e);d&&wa(d)&&d(e);b||a(e)}},Ko=function(a){var b=D[Ai()];try{if(wa(b)&&wa(b.getAll))return b.getAll().filter(function(c){return c.get("trackingId")===a})}catch(c){}return[]},Qo=function(a,b){var c=Lo[a];if(c)I(function(){return b(c)});else{var d=Ko(a)[0];d?(Lo[a]=d,Mo||(Mo=d),I(function(){return b(d)})):(No[a]||(No[a]=
[]),No[a].push(b),Oo||(Oo=!0,Jo(function(e){var f=e.get("trackingId");if(No[f]){if(Po[f]){Po[f]=!1;var h=D[Ai()];wa(h)&&h("ga.require","_"+Te.K)}Mo||(Mo=e);Lo[f]=e;for(var k=No[f],l;void 0!==(l=k.shift());)l(e);No[f]=void 0}})))}},Ro=function(a,b,c,d){var e=D[Ai()];if("data"===b.hitType&&c){var f=D.gaData,h=Number(f&&f[d]&&f[d].first_hit),k=Pa();!isNaN(h)&&k>h&&(b.queueTime=Math.min(2E3,k+100-h))}try{var l="t0"!=a.get("name")?a.get("name")+".send":"send";e(l,b)}catch(n){}},So=!1;
So=!0;var Lo={},No={},Po={},Mo,Oo=!1,To,Uo=function(a,b,c){Qo(a,function(d){I(function(){Ro(d,b,c,a)})})},Vo=function(){var a=!1;Jo(function(){if(!a){var b=D[Ai()];wa(b)&&(b("ga.require","__"+Te.K),a=!0)}},!0)},Wo=function(a,b,c){var d=Io(),e=d[a]=d[a]||{};(e.pending_experiments=e.pending_experiments||{})[b]=c;e.experiments=e.experiments||{};e.experiments[b]=c},Xo=function(a){var b=Io()[a];return b?b.hitcount||0:0},$o=function(a,b,c,d){Go(b,
c);var e=d;if(d){var f=je(D.location,"host");je(me(d),"host")===f&&(d="",Yo(a)&&!So&&(e=d))}Jo(function(p){p.set("referrer",d?d:void 0)},!0);if(Yo(a))M.ga4_referrer_override=e,Zo(a,b,c);else{Wo(a,b,c);for(var h=Ko(a),k=ca(h),l=k.next();!l.done;l=k.next())l.value.set("referrer",d?d:void 0);if(0<Xo(a)){var n=h[0];n&&Ro(n,{hitType:"data"},!0,a)}}},Yo=function(a){return!!a&&"G-"===a.substring(0,2)},Zo=function(a,b,c){Yo(a)?Yl("experiment_impression",{_experiment_id:b,_variant_id:c},a,!0):(Wo(a,b,c),0<
Xo(a)&&Uo(a,{hitType:"data"},!0))};
var dp=function(a,b,c){function d(){f||(f=!0,!0!==ap&&(ap=!1),bp(c),Gm(Hm(),e))}Wm=a;var e="GTM-5VPWWP_"+b,f=!1;Im(e);D.google_optimize=D.google_optimize||{};var h=D.google_optimize;h["GTM-5VPWWP"]=h["GTM-5VPWWP"]||{};h["GTM-5VPWWP"].optimize_dyn=function(l){l.split(",").forEach(function(n){cp[n]=!0});ap=!0;d()};gd(a,void 0,d);var k=Hm();D.setTimeout(function(){d()},Number(k&&k.hide&&k.hide.timeout)||1E4)},bp=function(a){if(void 0!==ep){var b=ep-fp,c,d;ap?c=Pa()-ep:d=Pa()-ep;Xm({Wh:b,Ah:c,yh:d})}cp.optimize_ready=
!0;dn({event:"opt.dyn"});dn({event:"opt.js"});if(a&&0<a.length){var e={};Hm().forEach(function(f){var h=f.event;h&&(e[h]=!0)});a.forEach(function(f){e[f]&&dn({event:f})})}I(function(){Bi("_"+Te.K)})},Hm=function(){return D["dataLayer"]},gp=function(a,b,c,d,e,f,h){function k(u,v){v&&(r+="&"+u+"="+encodeURIComponent(v))}fp=Pa();if(a||b||c){var l=void 0;if(b){var n=Vg().aw;n&&(l=n[0])}if(f&&(a||c||l)){var p=1,r,q="GTM-5VPWWP_"+p++;Im(q);var t=function(u){To=u;ep=Pa();a||b?(r="?id=GTM-5VPWWP",
a&&k("cid",u),k("gclid",l),h&&(k("gtm_auth",""),k("gtm_preview","")),(h||a)&&k("cb",String(Math.random())),dp(r,p++,e)):bp(e);Gm(Hm(),q)};Yo(d)?$l("client_id",t,d,!0):(Po[d]=!0,Qo(d,function(u){return t(u.get("clientId"))}))}else bp(e)}},cp={},fp,ep,ap,Wm;var hp=function(a,b){this.Gc=a;this.Ub=b};hp.prototype.toString=function(){var a=""+this.Gc;1<this.Ub&&(a=a+"-"+this.Ub);return a};var ip=function(a,b){this.o=a;this.m=b};ip.prototype.toString=function(){return this.m+"."+this.o};
var jp=function(){var a=mf("optimize.cookie_path",2);return g(a)?a:"/"},lp=function(a,b){var c=new kp(a,b);c.Fh();return c},kp=function(a,b){this.H=Math.floor(new Date/864E5);this.C=a||"auto";this.m=b||jp();this.o=new hp(Pf(this.C),Tf(this.m));this.J=[];this.map={}};aa=kp.prototype;aa.nh=function(a){if(!a)return"";var b=this.Md(a);return b?b.o:""};aa.Rh=function(a,b,c,d,e){var f,h;f=void 0===f?10:f;h=void 0===h?3E3:h;if(!a)return!1;void 0==b&&(b="");this.Pc(a,new ip(b,c));this.Rg(e);return this.Eg(d,
f,h)};aa.Md=function(a){return this.map[a]};aa.mh=function(){for(var a=0,b=0;b<this.J.length;b++)"x"!==this.Md(this.J[b]).o[0]&&a++;return a};aa.Pc=function(a,b){a&&(""===b.o?this.Gf(a):(this.map[a]||this.J.push(a),this.map[a]=b))};aa.Sh=function(a){for(var b=0;b<a.length;b++)this.Pc(a[b][0],a[b][1])};aa.Gf=function(a){var b=za(this.J,a);0<=b&&this.J.splice(b,1);delete this.map[a]};aa.Lh=function(){for(var a=[],b=0;b<this.J.length;b++){var c=this.J[b];this.map[c].m<this.H&&a.push(c)}for(var d=0;d<
a.length;d++)this.Gf(a[d])};aa.lh=function(){for(var a=[],b=0;b<this.J.length;b++){var c=this.J[b];a.push([c,this.map[c]])}return a};aa.gh=function(){for(var a=0,b=0;b<this.J.length;b++)a=Math.max(a,this.map[this.J[b]].m);return 864E5*a};aa.toString=function(){if(0==this.J.length)return"";for(var a=[],b=0;b<this.J.length;b++){var c=this.J[b];a.push(c+"."+this.map[c].toString())}return"GAX1."+this.o.toString()+"."+a.join("!")};aa.Eg=function(a,b,c){var d=new Date;this.Lh();var e=this.mh();if(e>b||
e>(a||10)&&Bf().replace(/(?:;\s*)?(_gaexp=[^;]+)(?:;\s*)?/,this.toString()).length>c)return!1;d.setTime(this.gh());if("auto"!=this.C)return this.o=new hp(Pf(this.C),Tf(this.m)),0===Lf("_gaexp",this.toString(),{path:this.m,domain:this.C,expires:d});for(var f=If(),h=0;h<f.length;h++)if(this.o=new hp(Pf(f[h]),Tf(this.m)),0===Lf("_gaexp",this.toString(),{path:this.m,domain:f[h],expires:d}))return!0;return!1};aa.Fh=function(){var a=Ff("_gaexp",this.o.Gc,this.o.Ub);if(a){var b=this.Gh(a);b&&this.Sh(b.lh())}};
aa.Gh=function(a){for(var b=new kp(this.C,this.m),c=a.split("!"),d=0;d<c.length;d++){var e=c[d].split(".");if(3==e.length){if(isNaN(Number(e[1])))return;b.Pc(e[0],new ip(e[2],Number(e[1])))}}return b};aa.Rg=function(a){a=a||{};var b=0;a.hasOwnProperty("")&&!isNaN(Number(a[""]))&&(b=this.H-Ja(a[""]));for(var c=0;c<this.J.length;c++){var d=this.J[c];if(a.hasOwnProperty(d)&&!isNaN(Number(a[d]))){var e=this.Md(d);e.m=Ja(a[d])+b;this.Pc(d,e)}}};
var qp=function(){mp=Pa();var a=np;np=[];for(var b=0;b<a.length;b++)a[b]();op&&(op.takeRecords(),np.length||(op&&(op.disconnect(),op=null),pp&&(D.clearTimeout(pp),pp=null)))},sp=function(){var a=Pa()-mp;a>=rp?(pp&&(D.clearTimeout(pp),pp=null),qp()):pp||(pp=D.setTimeout(function(){qp();pp=null},rp-a))},tp=function(a){if(!D.MutationObserver)return!1;try{return op||(op=new MutationObserver(sp),op.observe(F.documentElement,{subtree:!0,childList:!0,attributes:!0,characterData:!0}),mp=Pa()),np.push(a),
!0}catch(b){return!1}},op=null,np=[],rp=0,mp=0,pp=null;
var up=function(a,b){b&&tp(a)||D.setTimeout(a,80)},vp=function(a){try{return Ud(a)}catch(b){return null}},wp=function(a){if($h)return!0;for(;a;){if(a.nextSibling)return!0;a=a.parentNode}return!1},xp=function(a,b){for(var c=vp(a.T)||[],d=[],e=0;e<c.length;e++){var f=c[e];if(!f.gtmProgressiveApplied||!f.gtmProgressiveApplied[b]){if(a.ca&&!wp(f))break;d.push(f)}}return d},yp=function(a,b){return function(){a.gtmProgressiveApplied&&delete a.gtmProgressiveApplied[b]}},zp=function(a,b){a.gtmProgressiveApplied||
(a.gtmProgressiveApplied={});a.gtmProgressiveApplied[b]=!0},Ap=function(a,b,c){var d;var e=[];if(b.oa)if(b.oa.Fd)d=[{element:F.head}];else{var f=xp(b.oa,b.id),h=null;b.Qc&&(h=xp(b.Qc,b.id+"-t"));for(var k=0;k<f.length;k++){var l=f[k],n=void 0;if(null!=h&&(n=h.length>k?h[k]:null,!n&&!$h&&(null===b.Qc.S||b.lf+e.length<b.Qc.S)))break;e.push({element:l,Uh:n})}d=e}else d=e;var p=d;if(!$h&&b.Pg&&(!a||null==b.oa.S||b.oa.S!=b.Dc+p.length))return!1;for(var r=0;r<p.length;r++){var q=p[r].element,t=p[r].Uh,
u=void 0;b.Dc++;zp(q,b.id);t&&(b.lf++,u=b.id+"-t",zp(t,u));var v=b.Sg(q,t);wa(v)&&b.vb.push(v);b.vb.push(yp(q,b.id));t&&u&&b.vb.push(yp(t,u))}if(b.oa.S&&b.oa.S==b.Dc||$h&&(!c||b.Dc))b.finished=!0;return!0},Bp=function(a){for(var b={},c=0;c<a.la.length;c++){var d=a.la[c];if(!d.oa.Fd){var e=b[d.oa.T];e||(e=b[d.oa.T]=vp(d.oa.T)||[]);for(var f=0;f<e.length;f++){var h=e[f];h.gtmProgressiveApplied&&h.gtmProgressiveApplied[d.id]||(zp(h,d.id),d.vb.push(yp(h,d.id)))}}}},Cp=function(a){if(!a.be){for(var b=
a.Pb;b<a.la.length;b++){var c=a.la[b],d=b==a.Pb;if(!c.finished&&!Ap(d,c,a.Pf&&a.Of))break;c.finished&&d&&a.Pb++}a.la.length>a.Pb?(!a.pending&&a.Pf&&(a.pending=!0,up(function(){a.pending=!1;Cp(a)},a.Of)),$h||a.Wd||(a.Wd=function(){I(function(){Cp(a)})},kd(F,"DOMContentLoaded",a.Wd))):Bp(a)}},Dp={},Ep={},Fp=void 0,Gp=function(a,b,c,d){var e=Fp;if(!Td||!e)return!1;var f={id:e.id+":"+e.la.length,Sg:b,vb:[],Pg:c,oa:a,Dc:0,Qc:d||null,lf:0,finished:!1};e.la.push(f);null===a?(f.finished=!0,b(null)):Cp(e);
return!0},Hp=function(a){var b=va;try{b=go(a,"visibility","hidden",!0)}catch(c){}return function(){wa(b)&&b.apply();b=null}},Ip=function(a,b,c,d){var e=b;if(!$h&&!a.Fd){var f=Hp(a.T);bi.push(f);e=function(h,k){var l=b(h,k);f();return l}}return Gp(a,e,c,d)};function hq(){return D.gaGlobal=D.gaGlobal||{}}var iq=function(){var a=hq();a.hid=a.hid||Ca();return a.hid},jq=function(a,b){var c=hq();if(void 0==c.vid||b&&!c.from_cookie)c.vid=a,c.from_cookie=b};var Gq=function(){if(wa(D.__uspapi)){var a="";try{D.__uspapi("getUSPData",1,function(b,c){if(c&&b){var d=b.uspString;d&&/^[\da-zA-Z-]{1,20}$/.test(d)&&(a=d)}})}catch(b){}return a}};var $q=window,ar=document,br=function(a){var b=$q._gaUserPrefs;if(b&&b.ioo&&b.ioo()||a&&!0===$q["ga-disable-"+a])return!0;try{var c=$q.external;if(c&&c._gaUserPrefs&&"oo"==c._gaUserPrefs)return!0}catch(f){}for(var d=yf("AMP_TOKEN",String(ar.cookie),!0),e=0;e<d.length;e++)if("$OPT_OUT"==d[e])return!0;return ar.getElementById("__gaOptOutExtension")?!0:!1};var cr={};function fr(a){delete a.eventModel[B.Ib];hr(a.eventModel)}var hr=function(a){Fa(a,function(c){"_"===c.charAt(0)&&delete a[c]});var b=a[B.Da]||{};Fa(b,function(c){"_"===c.charAt(0)&&delete b[c]})};var kr=function(a,b,c){Yl(b,c,a)},lr=function(a,b,c){Yl(b,c,a,!0)},rr=function(a,b){};
...
Z.g.exs=["google"],function(){(function(a){Z.__exs=a;Z.__exs.h="exs";Z.__exs.i=!0;Z.__exs.priorityOverride=0})(function(a){var b=lp(a.vtp_cookieDomain,a.vtp_cookiePath).nh(a.vtp_measurementId);if(""===b)return b;if("x"===b[0]){var c=Number(b.substring(1));if("x"===b||isNaN(c)||0>c||1E3<=c)return""}else{var d=a.vtp_sections;if(d){var e=b.split("-");if(d.length!=e.length)return"";for(var f=0;f<d.length;f++)if(0>e[f]||e[f]>=d[f])return""}}return b})}();

Z.g.sel=["google"],function(){(function(a){Z.__sel=a;Z.__sel.h="sel";Z.__sel.i=!0;Z.__sel.priorityOverride=0})(function(a){return Ud(a.vtp_selector)})}();
Z.g.c=["google"],function(){(function(a){Z.__c=a;Z.__c.h="c";Z.__c.i=!0;Z.__c.priorityOverride=0})(function(a){Tn(a.vtp_value,"c",a.vtp_gtmEventId);return a.vtp_value})}();
...
Z.g.exsu=["google"],function(){(function(a){Z.__exsu=a;Z.__exsu.h="exsu";Z.__exsu.i=!0;Z.__exsu.priorityOverride=0})(function(a){lp(a.vtp_cookieDomain,a.vtp_cookiePath).Rh(a.vtp_measurementId,a.vtp_newState,a.vtp_expirationDay,a.vtp_max,a.vtp_expirationDates)?a.vtp_gtmOnSuccess():a.vtp_gtmOnFailure()})}();
Z.g.ctto=["google"],function(){(function(a){Z.__ctto=a;Z.__ctto.h="ctto";Z.__ctto.i=!0;Z.__ctto.priorityOverride=0})(function(a){var b=a.vtp_isDynamic,c=W("dataLayer"),d=c&&c.hide;if(!d)return!1;var e=Te.K,f=W("document");if(void 0===f.querySelector)return!1;var h=!!f.querySelector("body");if(null!==d.end||!h)return!1;if(!b)return!0===d[e];for(var k in d)if(d.hasOwnProperty(k)&&k.startsWith(e)&&!0===d[k])return!0;return!1})}();
Z.g.dr=["google"],function(){(function(a){Z.__dr=a;Z.__dr.h="dr";Z.__dr.i=!0;Z.__dr.priorityOverride=0})(function(a){var b=a.vtp_treatmentId,c=a.vtp_activate,d=a.vtp_contentSignature,e=a.vtp_isEmpty,f=Kn("optimize.experimentCallback",1),h=a.vtp_measurementId,k=a.vtp_experimentCombination,l=!!a.vtp_useMutationObserver,n=l?!!a.vtp_waitForElements:!0,p;if(p=c){var r=Dp[h];p=!(!r||r==b)}if(p)a.vtp_gtmOnFailure();else{var q=Kn("optimize.whitelist",1);if(q&&q[h]?q[h]===d:Th()?e:1){if(wa(f)){var t={xid:h,
xvar:k,activate:c};try{f(t)}catch(H){}}var u=!1,v=!0;if(c){var x;Dp[h]=b;var z=Ep[b];if(z){for(var w=z.Pb=0;w<z.la.length;w++)z.la[w].finished=!1;Cp(z);x=!0}else x=!1;if(x)u=!0;else{var y=Ep[b];y||(y={id:b,la:[],Pb:0,pending:!1,Wd:void 0,be:!1,Of:l,Pf:n},Ep[b]=y);Fp=y}}else{var A=Ep[b];if(!A||A.be)v=!1;else{for(;A.la.length;)for(var C=A.la.pop();C.vb.length;){var G=C.vb.pop();if(wa(G))try{G()}catch(H){}}A.be=!0;delete Ep[b];v=!0}}v&&Go(h,c?k:void 0);a[u?"vtp_gtmOnFailure":"vtp_gtmOnSuccess"]()}else a.vtp_gtmOnFailure()}})}();
...
Z.g.asprv=["google"],function(){function a(){Ln({event:"optimize.domChange"});tp(a)}(function(b){Z.__asprv=b;Z.__asprv.h="asprv";Z.__asprv.i=!0;Z.__asprv.priorityOverride=0})(function(b){var c=b.vtp_globalName,d=!!b.vtp_listenForMutations,e=Kn("eventModel");c&&Do(c);d&&a();var f,h,k;e&&(f=e.name||"",h=e.callback,k=e.remove);if(h&&wa(h))if(f=String(f),!0!==k){var l=f,n=h;Eo(l).push(n);if(""!==l)void 0!==Co[l]&&Fo(n,l,Co[l]);else for(var p in Co)void 0!==Co[p]&&Fo(n,p,Co[p])}else{var r=h,q=Eo(f),t=
q.indexOf(r);0<=t&&q.splice(t,1)}b.vtp_gtmOnSuccess()})}();Z.g.gaoo_c=["google"],function(){(function(a){Z.__gaoo_c=a;Z.__gaoo_c.h="gaoo_c";Z.__gaoo_c.i=!0;Z.__gaoo_c.priorityOverride=0})(function(a){var b=W("_gaUserPrefs");try{if(b&&b.ioo&&b.ioo())return!0}catch(d){}if(F.getElementById("__gaOptOutExtension"))return!0;var c=W("external");return c&&"oo"==c._gaUserPrefs?!0:!!W("ga-disable-"+a.vtp_trackingId)})}();
...
Z.g.eximp=["google"],function(){var a=!1;(function(b){Z.__eximp=b;Z.__eximp.h="eximp";Z.__eximp.i=!0;Z.__eximp.priorityOverride=0})(function(b){var c=b.vtp_trackingId,d=b.vtp_measurementId,e=b.vtp_variantId;if(a){Wo(c,d,e);var f=W("gaData",{},!1);f.expId=d;f.expVar=e;Uo(c,{hitType:"data"},!1)}else Zo(c,d,e);b.vtp_gtmOnSuccess()})}();var sr={};sr.macro=function(a){if(mn.Cd.hasOwnProperty(a))return mn.Cd[a]},sr.onHtmlSuccess=mn.qf(!0),sr.onHtmlFailure=mn.qf(!1);sr.dataLayer=nf;sr.callback=function(a){df.hasOwnProperty(a)&&wa(df[a])&&df[a]();delete df[a]};sr.bootstrap=0;sr._spx=!1;function tr(){M[Te.K]=sr;Ta(ef,Z.g);Rb=Rb||mn;Sb=$b}
function ur(){var a=!1;a&&ni("INIT");vd.o().o();M=D.google_tag_manager=D.google_tag_manager||{};sk();
Ig.enable_gbraid_cookie_write=!0;if(M[Te.K]){var b=M.zones;b&&b.unregisterChild(Te.K);Bi(Te.K);}else{for(var c=data.resource||{},d=c.macros||[],e=0;e<d.length;e++)Fb.push(d[e]);for(var f=c.tags||[],h=0;h<f.length;h++)Nb.push(f[h]);for(var k=c.predicates||[],l=0;l<k.length;l++)Mb.push(k[l]);for(var n=c.rules||[],p=0;p<n.length;p++){for(var r=n[p],q={},t=0;t<
...
(function(a){if(!D["__TAGGY_INSTALLED"]){var b=!1;if(F.referrer){var c=me(F.referrer);b="cct.google"===je(c,"host")}if(!b){var d=Cf("googTaggyReferrer");b=d.length&&d[0].length}b&&(D["__TAGGY_INSTALLED"]=!0,gd("https://cct.google/taggy/agent.js"))}var e=!0;if(e){a();return}var f=function(){var n=D["google.tagmanager.debugui2.queue"];n||(n=[],D["google.tagmanager.debugui2.queue"]=n,gd("https://www.googletagmanager.com/debug/bootstrap"));var p={messageType:"CONTAINER_STARTING",data:{scriptSource:dd,containerProduct:"GTM",debug:!1}};p.data.resume=function(){a()};p.data.containerProduct="OPT";Te.Uf&&(p.data.initialPublish=!0);n.push(p)},h="x"===ke(D.location,"query",!1,void 0,"gtm_debug");if(!h&&F.referrer){var k=me(F.referrer);h="tagassistant.google.com"===je(k,"host")}if(!h){var l=Cf("__TAG_ASSISTANT");h=l.length&&l[0].length}D.__TAG_ASSISTANT_API&&(h=!0);h&&dd?f():a()})(ur);
